...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // مسارات الـ CRUD الأساسية (تأتي بعد المسارات المخصصة)
